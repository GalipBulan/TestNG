...
public class C01_HTML_Reports extends TestBaseRapor {
    ...
    public void test01(){
        ...
        // amazona gidelim
        Driver.getDriver().get(ConfigReader.getProperty("amazonUrl")); // info bilgi vermek icin
        ...
        extentTest.pass("Arama sonuclarinin Nutella icerdigi test edildi"); // pass bir assertion olduysa onu gormek icin
    }
}
