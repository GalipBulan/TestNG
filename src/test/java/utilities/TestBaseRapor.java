...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "Galip");
        extentHtmlReporter.config().setDocumentTitle("Ilk Test"); // Belgenin basligi
        extentHtmlReporter.config().setReportName("TestNG Reports"); // Raporun adi
    }
